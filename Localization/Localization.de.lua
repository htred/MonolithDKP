if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    ADDNEGTTDESC = "Wenn diese Option aktiviert ist, wird die Verschuldung eines Spielers mit negativen DKP um den oben angegebenen Prozentsatz reduziert. Alle anderen werden um einen höheren Prozentsatz gekürzt. Nicht angekreuzte Spieler im Negativ sind vom Zerfall nicht betroffen.",
    ...
    AUTOOPEN = "Bietfenster automatisch öffnen",
    ...
    BCASTVALUESTTDESC = "Übertrage über Mindestgebotswerte an alle Offiziere. Dadurch werden auch alle benutzerdefinierten Werte gesendet, die für bestimmte Elemente im Gebotsfenster festgelegt wurden.",
